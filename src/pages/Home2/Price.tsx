...
export default function Price() {
  return (
    <div className="mt-8 pt-8 w-full max-w-6xl mx-auto lg:w-[900px] px-4">
      <div>
        {/* Rating Section */}
        <div
          style={{ border: "1px solid #E4EAF8" }}
          className="flex flex-col h-auto  lg:h-[69px]  
           lg:w-[400px]   md:w-[500px] md:h-[69px]  md:flex-row lg:flex-row items-center justify-between bg-white dark:bg-black 
            dark:border-red-600 mx-auto text-center rounded-3xl p-6 mb-14 space-y-4 lg:space-y-0 lg:space-x-6"
        >
          <div>
        ...
        <div className="space-y-10">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between gap-8">
            ...
            {/* Unlimited Services */}
            <div className="bg-white dark:bg-[#4E47FF] p-6 rounded-2xl shadow-lg flex flex-col lg:flex-[2] space-y-8">
                ...
                <ul className="space-y-4 flex-1">
                  {Array(3)
                    ...
                    .map((_, index) => (
                      <li
                        key={index}
                        className="flex dark:text-white items-center"
                      >
              ...
              <div className="bg-gray-100 dark:bg-dark-gradient p-6 rounded-lg flex items-center justify-between">
                <div className="text-3xl lg:text-4xl font-bold text-gray-800 dark:text-white">
                  $3,250{" "}
                  <span className="text-lg font-normal text-[#8987A1] dark:text-white">
                    /mo
                  </span>
                </div>
                <button className="text-black text-2xl">&rarr;</button>
              </div>
            </div>
          </div>
        </div>
