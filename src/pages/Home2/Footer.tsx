        ...
        <div className="bg-white  dark:bg-dark-gradient rounded-3xl shadow-lg p-10">
          <div className="flex flex-col  h-[208px]  lg:flex-row justify-between items-center lg:items-start">
            ...
            <div className="flex space-y-6 flex-col items-center w-[300px] lg:items-start">
              ...
              <p className="text-sm text-[#8987A1] dark:text-white flex ">
                <img src={`${heart}`} className="me-2" alt="" /> Made with
                powered by
                <a href="https://inkyy.com" className="text-indigo-500 dark:text-white ms-2">
                  inkyy.com
                </a>
              </p>
            </div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="#">
                  <img
                    src={`${Linkin}`}
                    alt="TikTok"
                    className="h-6 w-6  dark:text-white hover:opacity-80"
                  />
                </a>
              </div>
            </div>
